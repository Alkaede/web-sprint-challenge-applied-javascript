...
2. What is an event?
   1. something like a mouse click, or key press
3. What is an event listener?
   1. an object that can handle an event that it is attached to
4. Why would we convert a NodeList into an Array?
   1. to allow us to use javascript to do more than just forEach functions on the nodelist we are returning
5. What is a component?
   1.  an element allows us to create reusable elements
